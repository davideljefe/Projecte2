<footer class="text-center footer-style" style="margin-top: 50px;">
  <div id="footer" style="margin-left: 50px;">
    <div class="container">
     <div class="row">
      <div class="col-md-4 footer-col">
            <a href="nosaltres.php" style="color: black;"><h3>Sobre Nosaltres</h3></a>
        ...
        <div class="col-md-4 footer-col">
            ...
            <ul class="list-inline">
                ...
                <li>
                  <div style="display: flex; margin-left: 85px; margin-bottom: 25px;">
